"""
Reproduce Figure 8 of the ZEST paper.
Plots Hydrogen Lyman-alpha line shapes at Ne = 10^17 cm^-3 and T = 1, 10, 100 eV.
...
def simulate_figure8():
    ...
    wavenumbers_calc = np.linspace(-400.0, 400.0, 1200)   # cm^-1
    ...
    ax.set_title(r"Figure 8. Lyman-$\alpha$ line shapes of Hydrogen at $N_e=10^{17}\,\mathrm{cm}^{-3}$",
                 fontweight='bold')
