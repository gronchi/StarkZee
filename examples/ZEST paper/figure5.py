"""
Reproduce Figure 5 of the ZEST paper.
Plots Hydrogen Lyman-beta line shapes at Ne = 10^17 cm^-3, T = 100 eV.
...
def simulate_figure5():
    ...
    wavenumbers_grid = np.linspace(-400.0, 400.0, 800)   # cm^-1
    ...
    # Convert [1/eV] → [1/cm^-1] then area-normalize over the wavenumber grid.
    ...
    ax.set_title(r"Figure 5. Lyman-$\beta$ line shapes of hydrogen", fontweight='bold')
